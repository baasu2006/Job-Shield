  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 space-y-6">
      ...
      <div className="text-center">
        <h3 className="text-xl font-bold text-slate-800">Analyzing job patterns...</h3>
        <p className="text-slate-500 text-sm max-w-xs mx-auto mt-2">
          Comparing the description against thousands of known scam templates using Google Gemini.
        </p>
      </div>
    </div>
  );
